...
#'  \item{deaths}{\[`numeric()`\]\cr Age-specific deaths recorded in intercensal
#'   period (total, not mean annual deaths)}
#'  \item{migrants}{\[`numeric()`\]\cr Age-specific net migration recorded in
#'   intercensal period (total, not mean annual net migrants)}
#'  \item{age_start}{\[`integer()`\]\cr Lower bound of 5-year age group}
